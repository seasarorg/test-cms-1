...
public class WikiParser/*@bgen(jjtree)*/implements WikiParserTreeConstants, WikiParserConstants {/*@bgen(jjtree)*/
  protected JJTWikiParserState jjtree = new JJTWikiParserState();
    ...
    protected String getErrorLine(){
        ...
        log_.error("current position :" + curpos);
        log_.error("start position :" + startpos_);
        log_.error("Token Begin :" + jj_input_stream.tokenBegin);
        log_.error("Token Source Matched Position :" + token_source.jjmatchedPos);
...
//		initStartPosition();
                ...
                log_.error(msg);
                log_.error(enode.letter);
        }

  void SyntaxError() throws ParseException {
    trace_call("SyntaxError");
    try {
     ...
     try {ParseException e = generateParseException();
      ...
      trace_return("SyntaxError");
    }
  }

  void SkipToNewline() throws ParseException {
    trace_call("SkipToNewline");
    try {
      ...
      try {
        t = jj_consume_token(ANYOTHER);
          ...
          jjtc000 = false;
                ...
                log_.warn("AnyOther token : " + t.image);
      } finally {
          if (jjtc000) {
            jjtree.closeNodeScope(jjtn000, true);
          }
